      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                AvatarImage(imageUrl:appointment.avatar,name:appointment.doctorName, radius: 55,onTap: () {Navigator.push(context,
                      MaterialPageRoute(builder: (context) => DoctorProfile(id: appointment.doctorID),));
                },),
